...
public class CommentListControllerTest extends TestCase {
	...
	public void testAddNewComment() {
		CommentModel returned = controller.addNewComment("the comment", null, "username", null);
	...
	public void testAddNewCommentWithPicture() {
		...
		CommentModel returned = controller.addNewComment("the comment", picture, "username", null);
