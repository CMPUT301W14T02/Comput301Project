...
public class LocationModel extends Application {
	...
	/*
	 * this is used to get the context, if we add this to the singleton, passing
	 * it here may be unnecessary -KW
	 */
	...
	public LocationModel(Context c) {
		...
		LocationManager locationManager = (LocationManager) currContext
