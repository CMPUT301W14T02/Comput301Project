...
public class BrowseTopLevelCommentsActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<CommentModel> topLevelCommentList = ProjectApplication.getCommentList();
	
		// Add comments to adapter
		adapter = new ArrayAdapter<CommentModel>(this, R.layout.list_item, topLevelCommentList);
